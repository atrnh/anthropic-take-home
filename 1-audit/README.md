...
Here's how I'd organize **Extend Claude**. The [proposed
IA](proposed-ia.md#organize-by-capability-and-task) contains the full tree with expanded
sections.

> [!NOTE]
> The tree below proposes a potential navigation and page structure. Interpret each label
> as a description of what the page contains, not as the page's title.
