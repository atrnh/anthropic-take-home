...
def prepare(output_dir: Path, project: Path | None = None, *,
    ...
    examples_path = examples_path or project / "3-check/pilot/examples.json"
    results_path = project / "3-check/pilot/results.json"
    prompt_path = prompt_path or project / "3-check/pilot/judge-prompt.md"
