...
```sh
uv run python 3-check/docslint/duplicates.py corpus --examples 3-check/pilot/examples.json
...
```sh
uv run python 3-check/docslint/duplicates.py corpus --examples 3-check/pilot/examples.json > /tmp/claude-duplicates.json
```

After a successful exit, compare that file with `3-check/pilot/results.json`.
