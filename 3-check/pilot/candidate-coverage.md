...
```sh
uv run 3-check/docslint/candidates.py --output /tmp/claude-review-queue.json
cmp 3-check/pilot/review-queue.json /tmp/claude-review-queue.json
```
...
```sh
uv run 3-check/docslint/candidates.py \
  --examples 3-check/pilot/judge-v5/examples-adjudicated.json \
  --examples 3-check/pilot/judge-v5/examples-fresh.json \
