...
`uv run 3-check/docslint/bakeoff.py --expanded-extraction` admits unordered Markdown list
...
uv run 3-check/docslint/bakeoff.py --self-check > /tmp/claude-original.json
diff -u 3-check/pilot/tfidf-bakeoff.json /tmp/claude-original.json
uv run 3-check/docslint/bakeoff.py --expanded-extraction --self-check > /tmp/claude-expanded.json
diff -u 3-check/pilot/tfidf-expanded.json /tmp/claude-expanded.json
uv run 3-check/docslint/bakeoff.py --expanded-extraction --candidates > /tmp/claude-expanded-candidates.tsv
```
