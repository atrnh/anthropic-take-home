...
uv run 3-check/docslint/judge_pilot.py prepare --output-dir /tmp/claude-judge-pilot
diff -u 3-check/pilot/judge-packet.json /tmp/claude-judge-pilot/judge-packet.json
diff -u 3-check/pilot/judge-manifest.json /tmp/claude-judge-pilot/judge-manifest.json
uv run 3-check/docslint/judge_pilot.py evaluate \
  --packet 3-check/pilot/judge-packet.json \
  --manifest 3-check/pilot/judge-manifest.json \
  --judgments 3-check/pilot/judge-decisions.json > /tmp/claude-judge-metrics.json
diff -u 3-check/pilot/judge-metrics.json /tmp/claude-judge-metrics.json
```
