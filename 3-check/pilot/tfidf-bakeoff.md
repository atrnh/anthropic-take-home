...
```sh
uv run 3-check/docslint/bakeoff.py --self-check > /tmp/claude-tfidf-bakeoff.json
diff -u 3-check/pilot/tfidf-bakeoff.json /tmp/claude-tfidf-bakeoff.json
uv run 3-check/docslint/bakeoff.py --candidates > /tmp/claude-tfidf-candidates.tsv
