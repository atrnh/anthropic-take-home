...
```sh
uv run python docs/3-check/docslint/duplicates.py corpus --examples docs/3-check/pilot/examples.json
...
```sh
uv run python docs/3-check/docslint/duplicates.py corpus --examples docs/3-check/pilot/examples.json > /tmp/claude-duplicates.json
```

After a successful exit, compare that file with `docs/3-check/pilot/results.json`.
