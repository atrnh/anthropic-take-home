...
```sh
uv run docs/3-check/docslint/compare_faq_policy.py > /tmp/claude-v4-policy-comparison.json
cmp docs/3-check/pilot/judge-v2/v4-policy-comparison.json /tmp/claude-v4-policy-comparison.json
uv run docs/3-check/docslint/judge_pilot.py evaluate \
  --prompt docs/3-check/pilot/judge-v2/prompt-v4.md \
  --packet docs/3-check/pilot/judge-v2/judge-packet.json \
  --manifest docs/3-check/pilot/judge-v2/v4-manifest.json \
  --judgments docs/3-check/pilot/judge-v2/v4-decisions.json > /tmp/claude-v4-metrics.json
cmp docs/3-check/pilot/judge-v2/v4-metrics.json /tmp/claude-v4-metrics.json
```
...
uv run docs/3-check/docslint/judge_pilot.py prepare --sample-offset 2 \
  --output-dir /tmp/claude-judge-v2-control
cmp docs/3-check/pilot/judge-v2/judge-packet.json /tmp/claude-judge-v2-control/judge-packet.json
cmp docs/3-check/pilot/judge-v2/control-manifest.json /tmp/claude-judge-v2-control/judge-manifest.json
uv run docs/3-check/docslint/judge_pilot.py prepare --sample-offset 2 \
  --prompt docs/3-check/pilot/judge-v2/prompt.md --output-dir /tmp/claude-judge-v2
cmp docs/3-check/pilot/judge-v2/judge-packet.json /tmp/claude-judge-v2/judge-packet.json
cmp docs/3-check/pilot/judge-v2/judge-manifest.json /tmp/claude-judge-v2/judge-manifest.json
uv run docs/3-check/docslint/judge_pilot.py evaluate \
  --packet docs/3-check/pilot/judge-v2/judge-packet.json \
  --manifest docs/3-check/pilot/judge-v2/control-manifest.json \
  --judgments docs/3-check/pilot/judge-v2/control-decisions.json > /tmp/claude-control-metrics.json
cmp docs/3-check/pilot/judge-v2/control-metrics.json /tmp/claude-control-metrics.json
uv run docs/3-check/docslint/judge_pilot.py evaluate \
  --prompt docs/3-check/pilot/judge-v2/prompt.md \
  --packet docs/3-check/pilot/judge-v2/judge-packet.json \
  --manifest docs/3-check/pilot/judge-v2/judge-manifest.json \
  --judgments docs/3-check/pilot/judge-v2/judge-decisions.json > /tmp/claude-v2-metrics.json
cmp docs/3-check/pilot/judge-v2/judge-metrics.json /tmp/claude-v2-metrics.json
uv run docs/3-check/docslint/judge_pilot.py prepare --sample-offset 2 \
  --prompt docs/3-check/pilot/judge-v2/prompt-v3.md --output-dir /tmp/claude-judge-v3
cmp docs/3-check/pilot/judge-v2/judge-packet.json /tmp/claude-judge-v3/judge-packet.json
cmp docs/3-check/pilot/judge-v2/v3-manifest.json /tmp/claude-judge-v3/judge-manifest.json
uv run docs/3-check/docslint/judge_pilot.py evaluate \
  --prompt docs/3-check/pilot/judge-v2/prompt-v3.md \
  --packet docs/3-check/pilot/judge-v2/judge-packet.json \
  --manifest docs/3-check/pilot/judge-v2/v3-manifest.json \
  --judgments docs/3-check/pilot/judge-v2/v3-decisions.json > /tmp/claude-v3-metrics.json
cmp docs/3-check/pilot/judge-v2/v3-metrics.json /tmp/claude-v3-metrics.json
```
