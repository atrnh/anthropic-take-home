...
uv run docs/3-check/docslint/bakeoff.py --expanded-extraction \
  --examples docs/3-check/pilot/judge-v5/examples-adjudicated.json > /tmp/v5-retrieval.json
cmp docs/3-check/pilot/judge-v5/retrieval-adjudicated.json /tmp/v5-retrieval.json
uv run docs/3-check/docslint/judge_pilot.py prepare \
  --examples docs/3-check/pilot/judge-v5/examples-adjudicated.json \
  --prompt docs/3-check/pilot/judge-v5/prompt.md --output-dir /tmp/v5-familiar
cmp docs/3-check/pilot/judge-v5/familiar/judge-packet.json /tmp/v5-familiar/judge-packet.json
cmp docs/3-check/pilot/judge-v5/familiar/judge-manifest.json /tmp/v5-familiar/judge-manifest.json
uv run docs/3-check/docslint/judge_pilot.py evaluate \
  --examples docs/3-check/pilot/judge-v5/examples-adjudicated.json \
  --prompt docs/3-check/pilot/judge-v5/prompt.md \
  --packet docs/3-check/pilot/judge-v5/familiar/judge-packet.json \
  --manifest docs/3-check/pilot/judge-v5/familiar/judge-manifest.json \
  --judgments docs/3-check/pilot/judge-v5/familiar/decisions-a.json > /tmp/v5-metrics-a.json
cmp docs/3-check/pilot/judge-v5/familiar/metrics-a.json /tmp/v5-metrics-a.json
```
